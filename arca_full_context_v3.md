# ARCA v3.1 — Complete Codebase Context
- **Generated on**: 2026-04-19 01:43:11
- **GitHub**: https://github.com/DipayanDasgupta/arca
- **Architecture**: GNN + CleanRL PPO + LocalLLM Reflection + Lifelong Memory
...
│   │   ├── __init__.py
│   │   └── visualizer.py
│   ├── _cpp_sim.cpython-312-x86_64-linux-gnu.so
│   ├── __init__.py
│   └── __version__.py
├── examples
│   ├── quickstart.py
...
├── apply_fixes.sh
├── arca_full_context.md
├── arca_full_context_v3.md
├── audit.md
├── context.txt
├── generate_context.sh
├── logo.png
├── MANIFEST.in
├── my_home_network.yaml
├── my_office.yaml
├── pyproject.toml
├── pytest.ini
├── quickstart_v3.py
